...
function ApplicationTable({
  ...
  const [alertDialogProps, setAlertDialogProps] =
    useState<ConfirmationDialogProp | null>(null);
  ...
  const handleDeleteClick = (
    ...
    if (
      !confirmEmployeeAuthorization(employeeInfo.level, EmployeeLevel.LEVEL_2)
    ) {
    ...
    const application_team_name = currentApplications.find(
    ...
    setAlertDialogProps({
      ...
      description: (
        <>
          ...
          <span className="font-bold">{application_team_name}</span>{" "}
          application? <br />
  ...
  return (
    ...
    >
          ...
          <TableRow style={{ backgroundColor: "#1d1b23" }}>
            ...
            <TableHead className="relative">
              ...
              <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DropdownMenuContent
                  className="max-w-44 bg-black bg-opacity-70"
          ...
          {currentApplications.length === 0 ? (
            ...
            currentApplications.map((applicant) => (
              <TableRow
                ...
                className="bg-[#413F46] text-white"
              >
                ...
                <TableCell className="rounded-tr-[0.5rem] rounded-br-[0.5rem]">
                  {applicant.status !== Application_Status.APPROVED && (
                    <Button
                      ...
                      disabled={
                        !confirmEmployeeAuthorization(
                          employeeInfo.level,
                          EmployeeLevel.LEVEL_2
                        )
                      }
                    >
                      <Trash />
      ...
      <AlertDialog
        ...
        onOpenChange={() => setAlertDialogOpen(false)}
      >
