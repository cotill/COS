...
export const useApplications = ({
  ...
  const [all_applications, setAllApplications] = useState<Application[] | null>(
    null
  );
  ...
  const loadApplications = async () => {
    ...
    try {
      ...
      const application_result =
        await applicationService.fetchApplications(project_id);
  ...
  const handleApprove = async (
    ...
    try {
      await applicationService.rejectOtherApplications(
        application_id,
        project_id
      );
    } catch (error) {
    ...
    try {
      await applicationService.updateProjectStatus(
        project_id,
  ...
  async function handleDeleteAllApps() {
    ...
    setAlertDialogProps({
      ...
      description: (
        <>
          Are you sure you want to <span className="underline">delete all</span>{" "}
          unapproved applications? <br />
